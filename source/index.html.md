...
[
  {
    ...
    "payments": [
      {
        ...
        "number": 0,
        "percentage": 1,
        "due_deadline": "2018-02-07T23:08:44Z",
        "amount": {
          "amount_cents": 0,
          "currency_code": "string"
        },
        "submitted_at": "2018-02-07T23:08:44Z",
        "accepted_at": "2018-02-07T23:08:44Z",
        "paid_at": "2018-02-07T23:08:44Z",
    ...
    "next_payment_due_deadline": "2018-02-07T23:08:44Z",
    "product": {
      "images": [
        {
          "name": "string",
      ...
      "description": "string",
      "name": "string",
      "start_datetime": "2018-02-07T23:08:44Z",
      "end_datetime": "2018-02-07T23:08:44Z",
      ...
      "legal_documents": [
        {
          ...
          "title": "string",
          "content": "string",
          "created_at": "2018-02-07T23:08:44Z",
          "updated_at": "2018-02-07T23:08:44Z"
        }
      ]
    },
    "group": {
      "commit_deadline": "2018-02-07T23:08:44Z",
      "max_slots": 0,
      "min_slots": 0,
      "min_contribution": {
        "amount_cents": 0,
    ...
    "memberships": [
      {
        ...
        "current_contribution": {
          ...
          "charged_at": "2018-02-07T23:08:44Z",
          "failed_at": "2018-02-07T23:08:44Z",
          "created_at": "string"
        },
        "user": {
          "id": "string",
        ...
        "committed_at": "2018-02-07T23:08:44Z",
        "created_at": "2018-02-07T23:08:44Z"
      }
    ],
...
start datetime, due deadline, etc. You can update a purchase at any time until you accept
...
»» external_purchase_id|body|string|false|ID supplied by the merchant that identifies this Purchase<br/>(e.g. order or booking) in the merchant's system<br/>
»» costs|body|[[ProductCost](#schemaproductcost)]|false|The set of product_costs and the optional allowed range(s) of slots for each<br/>cost as provided by the merchant. When updating the product_costs, you cannot<br/>use a different currency than the existing one after the purchase has been<br/>claimed. You cannot edit the range of slots to be less than the current number<br/>of committed slots. You cannot set a product cost less than the total amount of<br/>payments already accepted for the purchase.<br/>
...
» payments|body|[object]|false|Breakdown of payment percentages, amounts and deadlines due over time for this Purchase.<br/>They can be updated as long as at least one payment is still `active` or `pending`.<br/>Values for the amount and the percentage of each payment can be provided as long as<br/>those values are consistent with the total purchase cost. If you are using multiple<br/>price ranges, you should ONLY update payments using the percentages and NOT amounts.<br/>
»» percentage|body|integer(int32)|false|Percent of the total purchase cost due for this payment, which must<br/>be an integer. All payments on a purchase must sum to 100. If you are<br/>not doing installment or deposit payments, this is most likely "100". If<br/>the payment is already captured, the percentage will be calculated<br/>automatically by the server, thus the specified value will be ignored.<br/>
»» amount|body|[Money](#schemamoney)|false|Partial amount of the total purchase cost due for this payment, which must be<br/>a Money object. All payment amounts on a purchase must sum to the total<br/>purchase cost. If you are not doing installment or deposit payments, this<br/>is most likely the total purchase cost. If both, the amount and percentage<br/>values are specified for a payment, the amount value takes precedence over<br/>the percentage. If the payment is already captured, the current amount of the<br/>payment will be used, thus the specified value will be ignored.<br/>
»» due_deadline|body|string(date-time)|false|Datetime by when this payment must be submitted to the merchant for<br/>the purchase to be valid. It is required for all payments after<br/>the first payment but may be passed for the first, or only, payment as well.<br/>
...
Parameter|In|Type|Required|Description
---|---|---|---|---|
id|path|string(uuid)|true|ID of the Payment to accept
...
They are always returned within the purchase or membership to which they correspond.
...
unsupported_cards|[string]|List of unsupported credit cards for this particular payment source if the type is `credit_card`. If none are listed, then all of Amex, Dankort, Diner's Club, Discover, JCB, MasterCard, and Visa are supported. 
