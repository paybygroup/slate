...
[
  {
    ...
    "payments": [
      {
        ...
        "number": 0,
        "percentage": 1,
        "due_deadline": "2017-11-23T04:32:15Z",
        "amount": {
          "amount_cents": 0,
          "currency_code": "string"
        },
        "submitted_at": "2017-11-23T04:32:15Z",
        "accepted_at": "2017-11-23T04:32:15Z",
        "paid_at": "2017-11-23T04:32:15Z",
    ...
    "next_payment_due_deadline": "2017-11-23T04:32:15Z",
    "product": {
      "images": [
        {
          "id": "string",
      ...
      "description": "string",
      "name": "string",
      "start_datetime": "2017-11-23T04:32:15Z",
      "end_datetime": "2017-11-23T04:32:15Z",
      ...
      "legal_documents": [
        {
          ...
          "title": "string",
          "content": "string",
          "created_at": "2017-11-23T04:32:15Z",
          "updated_at": "2017-11-23T04:32:15Z"
        }
      ]
    },
    "group": {
      "commit_deadline": "2017-11-23T04:32:15Z",
      "max_slots": 0,
      "min_slots": 0,
      "min_contribution": {
        "amount_cents": 0,
    ...
    "memberships": [
      {
        ...
        "current_contribution": {
          ...
          "charged_at": "2017-11-23T04:32:15Z",
          "failed_at": "2017-11-23T04:32:15Z",
          "created_at": "string"
        },
        "user": {
          "id": "string",
        ...
        "committed_at": "2017-11-23T04:32:15Z",
        "created_at": "2017-11-23T04:32:15Z"
      }
    ],
...
»» percentage|body|integer(int32)|false|Percent of the total purchase cost due for this payment, which must<br/>be an integer. All payments on a purchase must sum to 100. If you are<br/>not doing installment or deposit payments, this is most likely "100".<br/>
»» due_deadline|body|string(date-time)|false|Datetime by when this payment must be submitted to the merchant for<br/>the purchase to be valid. It is required for all payments after<br/>the first payment but may be passed for the first, or only, payment as well.<br/>
...
» group|body|object|split_type|No description
...
» url|body|string|true|URL of the image. It will only be retrieved once from this URL, after which it will be cached by Pay By Group.
» file|body|string(binary)|true|Image file
...
Consumer Field Values record what a user saves when presented with a Consumer Field Schema.
...
schema|[ConsumerFieldSchema](#schemaconsumerfieldschema)|The Consumer Field Schema object is a version of a Consumer Field Template that is specific to a Purchase. It is created as a variation on a Consumer Field Template when creating a Purcahse and will remain unchanged once it is created and attached to that Purchase, even if the template used to create it does change. Certain parameters of each template may be customized when creating a new Consumer Field Schema, including: `scope`, `required`, and `options`. 
slot|integer(int32)|Member's slot this field value is applied to.
value|string|Stored value entered by the member or organizer.
...
info|object|Detailed information of this payment source
...
chargable_type|string|Entity name of the chargable object related to this transaction.
